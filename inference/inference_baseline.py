...
def inference_naive(
    ...
    if model_id == "moonshotai/Kimi-VL-A3B-Instruct":
    ...
    elif model_id == "OpenGVLab/InternVL3-1B" or model_id == "OpenGVLab/InternVL3-2B" or model_id == "OpenGVLab/InternVL3-8B" or model_id == "OpenGVLab/InternVL3-78B":
        ...
        if not _MISTRAL_AVAILABLE:
            raise ImportError("Pixtral model requires mistral packages which are not installed")
