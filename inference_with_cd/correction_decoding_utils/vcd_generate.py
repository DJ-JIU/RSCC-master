...
def generate(
    ...
    noise_img: Optional[torch.FloatTensor] = None,
    ...
    def _vcd(
        ...
        **model_kwargs,
        ...
        while self._has_unfinished_sequences(
            ...
            model_kwargs_cd = deepcopy(model_kwargs)
            model_kwargs_cd["pixel_values"] = noise_img
